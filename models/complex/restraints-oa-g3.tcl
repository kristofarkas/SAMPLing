# load topology and initial coordinates
  mol new OA-G3-0/build/complex.prmtop type parm7
  mol addfile OA-G3-0/build/complex.rst7
  set outfile [open OA-G3-0/restraints/restraint_1.0.in w]

# selection
  set a1 [atomselect 0 "resname GST and name C4"]
  set a2 [atomselect 0 "resname GST and name C2"]
  set a3 [atomselect 0 "resname GST and name C1"]
...
# distance, andles and dihedrals
  set dist [measure bond {184 8}]
  set ang1 [measure angle {185 184 8}]
  set ang2 [measure angle {184 8 7}]
  set dih1 [measure dihed {187 185 184 8}]
  set dih2 [measure dihed {185 184 8 7}]
  set dih3 [measure dihed {184 8 7 37}]
